...
public static void main(String[] args) {
	...
	LCS4 lcs;
   lcs = new LCS4("GBATACAT", "ABBAACCTTC");
   lcs.printCell();
   System.out.println();
   lcs.printPath();
   ...
   lcs = new LCS4("1101000110", "0101011010");
   lcs.printCell();
   System.out.println();
   lcs.printPath();
   System.out.printf("LCS using Dynamic Version of the algorithm = %1$s\n\n", lcs.deriveLCS());
   ...
   lcs = new LCS4("AGTTCGGCCT", "GTTAGGCTAC");
   lcs.printCell();
   System.out.println();
   lcs.printPath();
   System.out.printf("LCS using Dynamic Version of the algorithm = %1$s\n\n", lcs.deriveLCS());
   ...
   lcs = new LCS4("110100011001101", "110100101011010");
   lcs.printCell();
   System.out.println();
   lcs.printPath();
   System.out.printf("LCS using Dynamic Version of the algorithm = %1$s\n\n", lcs.deriveLCS());
   ...
   lcs = new LCS4("ACTGTTAAGGCCGT", "AACTTGGATCGTCAT");
   lcs.printCell();
   System.out.println();
   lcs.printPath();
   System.out.printf("LCS using Dynamic Version of the algorithm = %1$s\n\n", lcs.deriveLCS());
   ...
   //Addressing Exercise 15.4-1 on page 396/397 of CLRS	
 	...
 	lcs = new LCS4("10010101","010110110");
   lcs.printCell();
   System.out.println();
   lcs.printPath();
   System.out.printf("LCS using Dynamic Version of the algorithm = %1$s\n\n", lcs.deriveLCS()); */
